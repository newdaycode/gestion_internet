<!-- Inicio Modal -->
<div id="ModalServicio" class="modal fade" data-backdrop="static">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form id="ForServicio" autocomplete="off">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="agregar_servicio" class="btn btn-rounded btn-primary">Registrar</button>
                </div>                
            </form>
        </div>
    </div>
